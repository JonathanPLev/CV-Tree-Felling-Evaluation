...
Since we are working with a small dataset, we introduce a lower learning rate, partial layer freezing of the original pretrained model, and moderate augmentation as a start. Then test with multiple different sets of hyperparameters.